...
![选择并启动 VIA 工作区](https://raw.githubusercontent.com/si-view/via-vscode/master/media/VIAWorkSpace.gif)

### 运行段落

![运行当前 SKILL 段落](https://raw.githubusercontent.com/si-view/via-vscode/master/media/RunningParagraph.gif)

### 保存时自动加载

启用 `via.loadOnSave` 后，保存 `.il` 文件时会自动加载到当前 VIA 工作区。

![启用保存时自动加载](https://raw.githubusercontent.com/si-view/via-vscode/master/media/LoadOnSave.png)
...
![芯上视图公众号二维码](https://raw.githubusercontent.com/si-view/via-vscode/master/media/qrcode.jpg)
